...
registerRoute(
  ({ url }) =>
    url.pathname.includes('/assets/models-local/') ||
    url.pathname.includes('/assets/models/') ||
    url.pathname.includes('/assets/browser-models-local/') ||
    url.pathname.includes('/assets/browser-models/') ||
    url.pathname.includes('/assets/transformers/') ||
...
registerRoute(
  ({ url }) =>
    ...
    url.pathname.endsWith('/assets/browser_model_manifest.json'),
