...
MANUAL_AUTO_ITEMS = [
    ...
    {"from": "마춰서", "to": "맞춰서", "reasonTag": "phrase_memory:마춰서->맞춰서", "confidence": 0.99},
    {"from": "문제를 마 추고", "to": "문제를 맞히고", "reasonTag": "phrase_memory:문제를 마 추고->문제를 맞히고", "confidence": 0.99},
    {"from": "문제를 마추고", "to": "문제를 맞히고", "reasonTag": "phrase_memory:문제를 마추고->문제를 맞히고", "confidence": 0.99},
    {"from": "정답을 마 추고", "to": "정답을 맞히고", "reasonTag": "phrase_memory:정답을 마 추고->정답을 맞히고", "confidence": 0.99},
    {"from": "정답을 마추고", "to": "정답을 맞히고", "reasonTag": "phrase_memory:정답을 마추고->정답을 맞히고", "confidence": 0.99},
    {"from": "답을 마 추고", "to": "답을 맞히고", "reasonTag": "phrase_memory:답을 마 추고->답을 맞히고", "confidence": 0.99},
    {"from": "답을 마추고", "to": "답을 맞히고", "reasonTag": "phrase_memory:답을 마추고->답을 맞히고", "confidence": 0.99},
    {"from": "시간을 마 추고", "to": "시간을 맞추고", "reasonTag": "phrase_memory:시간을 마 추고->시간을 맞추고", "confidence": 0.99},
    {"from": "시간을 마추고", "to": "시간을 맞추고", "reasonTag": "phrase_memory:시간을 마추고->시간을 맞추고", "confidence": 0.99},
    {"from": "정답을 맞췄다", "to": "정답을 맞혔다", "reasonTag": "phrase_memory:정답을 맞췄다->정답을 맞혔다", "confidence": 0.99},
    {"from": "답을 맞췄다", "to": "답을 맞혔다", "reasonTag": "phrase_memory:답을 맞췄다->답을 맞혔다", "confidence": 0.99},
    {"from": "문제를 맞췄다", "to": "문제를 맞혔다", "reasonTag": "phrase_memory:문제를 맞췄다->문제를 맞혔다", "confidence": 0.99},
    {"from": "정답을 맞추었다", "to": "정답을 맞혔다", "reasonTag": "phrase_memory:정답을 맞추었다->정답을 맞혔다", "confidence": 0.99},
    {"from": "답을 맞추었다", "to": "답을 맞혔다", "reasonTag": "phrase_memory:답을 맞추었다->답을 맞혔다", "confidence": 0.99},
    {"from": "문제를 맞추었다", "to": "문제를 맞혔다", "reasonTag": "phrase_memory:문제를 맞추었다->문제를 맞혔다", "confidence": 0.99},
    {"from": "시간을 맞혀서", "to": "시간을 맞춰서", "reasonTag": "phrase_memory:시간을 맞혀서->시간을 맞춰서", "confidence": 0.99},
    {"from": "시간을 맞히고", "to": "시간을 맞추고", "reasonTag": "phrase_memory:시간을 맞히고->시간을 맞추고", "confidence": 0.98},
    {"from": "시간을 맞히다", "to": "시간을 맞추다", "reasonTag": "phrase_memory:시간을 맞히다->시간을 맞추다", "confidence": 0.98},
    {"from": "약을 먹고 많이 낮아졌다", "to": "약을 먹고 많이 나아졌다", "reasonTag": "phrase_memory:약을 먹고 많이 낮아졌다->약을 먹고 많이 나아졌다", "confidence": 0.98},
    {"from": "몸이 많이 낮아졌다", "to": "몸이 많이 나아졌다", "reasonTag": "phrase_memory:몸이 많이 낮아졌다->몸이 많이 나아졌다", "confidence": 0.97},
    {"from": "상태가 많이 낮아졌다", "to": "상태가 많이 나아졌다", "reasonTag": "phrase_memory:상태가 많이 낮아졌다->상태가 많이 나아졌다", "confidence": 0.97},
    {"from": "병이 금방 낮는다", "to": "병이 금방 낫는다", "reasonTag": "phrase_memory:병이 금방 낮는다->병이 금방 낫는다", "confidence": 0.98},
    {"from": "감기가 금방 낮는다", "to": "감기가 금방 낫는다", "reasonTag": "phrase_memory:감기가 금방 낮는다->감기가 금방 낫는다", "confidence": 0.98},
    {"from": "상처가 금방 낮는다", "to": "상처가 금방 낫는다", "reasonTag": "phrase_memory:상처가 금방 낮는다->상처가 금방 낫는다", "confidence": 0.98},
    {"from": "안자 있었다", "to": "앉아 있었다", "reasonTag": "phrase_memory:안자 있었다->앉아 있었다", "confidence": 0.98},
    {"from": "안자있었다", "to": "앉아 있었다", "reasonTag": "phrase_memory:안자있었다->앉아 있었다", "confidence": 0.98},
